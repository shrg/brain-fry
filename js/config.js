...
export const CONFIG = {
  ...
  // Цель практики на день (минуты). 0 = выключено.
  goalPresets: [
    { label: "Выкл", value: 0 },
    { label: "5 мин", value: 5 },
  ...
  // Случайные поздравления при достижении дневной цели
  dailyCongrats: [
    "🎉 Цель дня взята! Мозг шкварчит как надо.",
    "🔥 Дневная норма выполнена. Brain officially fried.",
    "⚡️ Готово! Сегодня ты прокачал слух.",
    "🧠 Цель достигнута — уши стали острее.",
    "🏆 Дневной план закрыт. Красавчик.",
    "✨ Есть цель дня! Так держать.",
    "🎯 В яблочко — норма на сегодня выполнена.",
    "💪 Цель дня покорена. Завтра ещё?",
    "🚀 Дневная цель есть! Летим дальше.",
    "😎 Норма выполнена — можно собой гордиться.",
  ],
